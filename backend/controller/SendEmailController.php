...
class SendEmailController
{
    ...
    public function SendRegistrationCode($email, $code, $firstName, $lastName)
    {
        $mail = new PHPMailer(true);
        ...
        $mail->addAddress($email);
        $mail->isHTML(true);
        $mail->Subject = 'Felamo Registration Verification Code';
        $mail->Body = '
        <html>
        <head>
            <style>
        ...
        <body>
            <div class="container">
                <h1>Felamo Registration Verification Code</h1>
                <p>Hi ' . $firstName . ' ' . $lastName . ',</p>
                <p>Your Verification Code is:</p>
                <p class="verification-code">' . $code . '</p>
            </div>
